...
function StepNumber({ number }: { number: string }) {
  return (
    <div className="relative z-10 flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-2xl font-black text-white shadow-lg shadow-blue-950/50 ring-4 ring-zinc-950">
      {number}
    </div>
  );
}
  ...
  return (
    <section id="how-to-order" className="mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24">
      ...
      <div className="relative mt-20 hidden lg:block">
        <div className="absolute left-10 right-10 top-8 border-t-2 border-dashed border-white/10" />
      ...
      <div className="relative mt-14 lg:hidden">
        <div className="absolute bottom-6 left-8 top-6 border-l-2 border-dashed border-white/10" />
